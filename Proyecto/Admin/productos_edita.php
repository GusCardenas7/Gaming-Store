...
<html>
 ...
 <body>
    ...
    <label for="nombre">Nombre</label>
		<input type="text" name="nombre" placeholder="Escribe el nombre del producto" value="<?php echo $nombre ?>">
    <br>
    <label for="codigo" style="margin: 2px 0px 0px 430px;">Código</label>
    <input onblur="validarCodigo();" type="text" name="codigo" id="codigo" placeholder="Escribe el código del producto" value="<?php echo $codigo ?>">
    ...
    <textarea style="margin: 2px 0px 2px 8.2%;" name="descripcion" cols="30" rows="5" placeholder="Escribe la descripción del producto"><?php echo $descripcion ?></textarea>
    <br>
    <label for="costo">Costo</label>
    <input type="number" name="costo" step="0.01" min="0" placeholder="Escribe el costo del producto" value=<?php echo $costo ?>>
    <br>
    <label for="stock">Stock</label>
    <input type="number" name="stock" min="0" placeholder="Escribe el stock del producto" value=<?php echo $stock ?>>
    <br>
