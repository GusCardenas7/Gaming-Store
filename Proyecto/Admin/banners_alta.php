<?php
    ...
    echo "<div align='center' style='font-weight: bold; font-size: 40px;'>Alta de Banners</div><br>";
...
<html>
 ...
 <body>
	<form enctype="multipart/form-data" name="forma01" action="banners_salva.php" method="POST" align="center">
    <input type="hidden" name="id" id="id">
    <label for="nombre" style="margin: 2px 0px 0px 430px;">Nombre</label>
    <input onblur="validarNombre();" type="text" name="nombre" id="nombre" placeholder="Escribe el nombre del banner">
