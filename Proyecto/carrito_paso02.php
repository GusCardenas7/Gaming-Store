    ...
    <?php 
        if(isset($_SESSION['nombreC']) && !empty($_SESSION['nombreC'])){
            ...
            if($registros == 0) {
                ...
                echo "<h3 style='margin-left: 3%;'>Paso 2/2</h3>";
                ...
                echo "</div>
                <br>
                <input type='button' style='background-color: lightcoral; color: white; margin-left: 3%;' value='Regresar' onclick='paso1()'>
                <input type='button' style='background-color: lightcoral; color: white; margin-left: 1%;' value='Finalizar' onclick='finalizar($id_pedido)'>";
            }
        } else {
